...
- [iKuuuAPI](https://api.ikuapi.com/profile) `签到` `0.2`
- [小白code](https://token.dialoguedui.com/dashboard) `签到` `0.07-0.2`
- [AI-ROUTER](https://ai-router.dev/dashboard) `签到` `订阅制` `30刀`
- [DevPoolAi](https://xuseny.online/dashboard) `0.08` `剩余100刀`
- [iCodex](https://icodex.pro/dashboard) `0.1-0.4`
- [乾行](https://fast.qianxing.pro/profile) `0.1-0.25` `签到`
- [年华](https://newapi.makelove.cloud/profile) `0.15` `签到` `订阅制`
- [VC](https://sub.vcnovb.cn/lottery) `0.1` `签到`
- [归离@API](https://api3.guili.fun/dashboard) `0.05-0.15`

## 白嫖

- [AI8](https://ai8.my/profile) `0.08` `签到` `订阅制`
- [分享奇点](https://api-public.proxy-gls.de5.net/profile) `0.25` `签到` `白嫖`
- [2Chat](https://2chat.cc/dashboard) `0.06`
- [HUBWAY](https://hubway.cc/dashboard) `0.05`
- [Worldclawpro](https://worldclawpro.ai/dashboard/overview) `0.05`
- [Aizzz](https://api.aizzz.xyz/dashboard/overview) `0.07`
- [qiutian](https://qiutian.live/) `0.05` `无5.6s`
- [蹬蹬散户](https://www.open-hhh.store/dashboard) `0.05` `无5.6s`
...
- [麻豆科技](https://mdkj.lol/dashboard) `0.05` 
- [云舟API](https://cli.999554.xyz/console) `0.1`
- [寒鸦的小破站](https://api.hanhegufei.online/keys) `0.1`
- [刀刀刀](https://codexapis.com/console) `0.06-0.15`
- [Qingflow](https://jingyuqingfeng.cn/dashboard) `肥太狼` `0.1-0.18`
- [词元枢阁](https://api.aisz.mom/dashboard/overview) `0.1`
- [可达鸭](https://sub.kedaya.xyz/) `0.1`
- [(O—O)](https://0-0.pro/dashboard) `0.25` `备用`
- [Dawcode](https://dawcode.com/dashboard/overview) `0.35` `保底`
- [XHY中转](https://cc.v587xhy.com/console) `0.8` `克劳德` `次卡`
